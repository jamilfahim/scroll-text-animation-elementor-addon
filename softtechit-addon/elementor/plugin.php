...
{   
    wp_enqueue_style( 'split-style', plugin_dir_url( __FILE__ ) . 'assets/css/style.css',array(), '1.0.0', 'all' );
    wp_enqueue_script( 'highlight-text','https://assets.website-files.com/61fc5b41833dbe4e9b6d831b/js/highlight-text-tricks.7f033afae.js',array('jquery'), null, true );
    wp_enqueue_script( 'gsap','https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/gsap.min.js',array('jquery'),null, true );
    wp_enqueue_script( 'scroll-trigger','https://cdnjs.cloudflare.com/ajax/libs/gsap/3.8.0/ScrollTrigger.min.js',array('jquery'), null, true );
    wp_enqueue_script( 'split-type','https://unpkg.com/split-type',array('jquery'), null, true );
    wp_enqueue_script( 'custom-js',plugin_dir_url( __FILE__ ) . 'assets/js/custom.js',array('jquery'), null, true );
    //wp_enqueue_script( 'jquery-plugin','',array(), null, true );
